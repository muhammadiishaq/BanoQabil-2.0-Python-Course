...
# --------------------
wordFrame = pygame.image.load("back.jpg")# On which word would be printed
...
# -----------------------------------------------------------------------------------------------------------------------
# Level 1 lists
lst1 = ["apple", "banana","watermelon", "grape", "mango", "pear", "kiwi"]
lst2 = ["rose", "lily", "sunflower","louts","jasmine"]


# Level 2 lists
lst3 = ["tiger", "elephant", "dog", "lion",]
lst4 = ["bat", "cock", "eagle","sparrow","dove", "peacock", "hen",]


# Level 3 lists
lst5 = ["butterfly", "grasshopper", "honeybee","spider", "mosquito"]
lst6 = ["english", "urdu", "arabic", "pashto"]


# Level 4 lists
lst7 = ["english", "urdu", "maths", "chemistry", "physics","economics", "history"]
lst8 = ["paper", "pencil", "bag","ruler","colour", "sheet","book"]

# Level 5 lists
lst9 = ["cricket", "football", "hockey", "baseball","boxing", "polo","tennis"]
...
level_3_list = lst5 + lst6
level_4_list = lst7 + lst8
level_5_list = lst9
...
def startScreen():
    ...
    helpLine02 = helpFont.render("Abdur_Rahman Naseem Shah", True, white)
    helpLine03 = helpFont.render("Muhammad Ishaq", True, white)
    helpLine04 = helpFont.render("Muhammad Furqan", True, white)
